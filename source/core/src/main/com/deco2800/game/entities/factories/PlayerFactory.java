       ...
       String attire = updateAttireConfig();
        ...
        switch (attire) {
            ...
            case "gold_4":
                ...
                break;
            case "gold_6":
                mpcAnimator = createAnimationComponent("images/mpc/finalAtlas" +
                        "/gold_6_buff_to_be_tested/mpcAnimation_6.atlas");
                mpcTexture = new TextureRenderComponent("images/mpc/finalAtlas" +
                        "/gold_6_buff_to_be_tested/mpc_right.png");
                break;
            case "OG":
            default:
